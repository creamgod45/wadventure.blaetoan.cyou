...
INSERT INTO `cgphp_member` (`ID`, `uid`, `username`, `password`, `email`, `enable`, `administrator`, `createAt`,
                            `updateAt`)
VALUES (1, '1111', 'test', '1679797690', 'test@email.com', 'true', 'false', 0, '2023-03-26 02:28:10'),
